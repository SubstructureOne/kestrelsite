        ...
        <>
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <p>
                    ...
                    account or password. You may not assign or otherwise
                    transfer your account to any other person or entity. You
                    acknowledge that Substructure One is not responsible for
                    third party access to your account that results from theft
                    or misappropriation of your account. Substructure One and
                    its associates reserve the right to refuse or cancel
                    service, terminate accounts, or remove or edit content in
                    our sole discretion.
                </p>
                ...
                <p>
                    You may close your account at any time. Account balances of
                    $5.00 or more will be refunded on account closure. Please
                    contact us at contact@substructureone.com with any
                    questions.
                </p>
                ...
                <p>
                    ...
                    Substructure One of the site or any association with its
                    operators.
                </p>
                ...
                <p>
                    ...
                    manner which could damage, disable, overburden, or impair
                    the Site or interfere with any other party's use and
                    enjoyment of the Site. You may not obtain or attempt to
                ...
                <p>
                    ...
                    and any software used on the Site, is the property of
                    Substructure One or its suppliers and protected by copyright
                ...
                <p>
                    ...
                    in part, found on the Site. Substructure One content is not
                    for resale. Your use of the Site does not entitle you to
                    ...
                    permission of Substructure One and the copyright owner. You
                    agree that you do not acquire any ownership rights in any
                    protected content. We do not grant you any licenses, express
                    or implied, to the intellectual property of Substructure One
                ...
                <p>
                    ...
                    Substructure One from our offices within the USA. If you
                ...
                <p>
                    ...
                    Substructure One, its officers, directors, employees, agents
                    ...
                    laws, rules or regulations. Substructure One reserves the
                    right, at its own cost, to assume the exclusive defense and
                    control of any matter otherwise subject to indemnification
                    by you, in which event you will fully cooperate with
                    Substructure One in asserting any available defenses.
                </p>
                ...
                <p>
                    ...
                    unless both you and Substructure One agree otherwise, the
                ...
                <p>
                    ...
                    INFORMATION HEREIN. SUBSTRUCTURE ONE, LLC AND/OR ITS
                    SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN THE SITE
                    AT ANY TIME.
                </p>

                <p>
                    SUBSTRUCTURE ONE, LLC AND/OR ITS SUPPLIERS MAKE NO
                    ...
                    WARRANTY OR CONDITION OF ANY KIND. SUBSTRUCTURE ONE, LLC
                ...
                <p>
                    ...
                    EVENT SHALL SUBSTRUCTURE ONE, LLC AND/OR ITS SUPPLIERS BE
                    ...
                    USE OR PERFORMANCE OF THE SITE, WITH THE DELAY OR INABILITY
                    TO USE THE SITE OR RELATED SERVICES, THE PROVISION OF OR
                    ...
                    LIABILITY OR OTHERWISE, EVEN IF SUBSTRUCTURE ONE, LLC OR ANY
                    OF ITS SUPPLIERS HAS BEEN ADVISED OF THE POSSIBILITY OF
                    ...
                    YOU. IF YOU ARE DISSATISFIED WITH ANY PORTION OF THE SITE,
                ...
                <p>
                    ...
                    to terminate your access to the Site and the related
                    services or any portion thereof at any time, without notice.
                    To the maximum extent permitted by law, this agreement is
                    governed by the laws of the State of North Carolina and you
                    hereby consent to the exclusive jurisdiction and venue of
                    courts in North Carolina in all disputes arising out of or
                    relating to the use of the Site. Use of the Site is
                    unauthorized in any jurisdiction that does not give effect
                    to all provisions of these Terms, including, without
                    limitation, this section.
                </p>

                <p>
                    You agree that no joint venture, partnership, employment, or
                    agency relationship exists between you and Substructure One
                    as a result of this agreement or use of the Site.
                    Substructure One's performance of this agreement is subject
                    to existing laws and legal process, and nothing contained in
                    this agreement is in derogation of Substructure One's right
                    to comply with governmental, court and law enforcement
                    requests or requirements relating to your use of the Site or
                    information provided to or gathered by Substructure One with
                ...
                <p>
                    ...
                    Substructure One with respect to the Site and it supersedes
                    all prior or contemporaneous communications and proposals,
                    whether electronic, oral or written, between the user and
                    Substructure One with respect to the Site. A printed version
                    of this agreement and of any notice given in electronic form
                ...
                <p>
                    Substructure One welcomes your questions or comments
                    regarding the Terms:
                </p>

                <p>
                    Substructure One, LLC
                    <br />
                    600 Park Offices Drive, Suite 300 #19
                    <br />
