    ...
    return (
        <>
                ...
                <div className="mask w-slider-mask">
                    <div className="slide w-slide">
                        <div className="w-container">
                            ...
                            <h1 className="main-heading bold">
                                Open Source
                                <br />
                            ...
                            <div className="main-subheading">
                                Deploy open source software at scale without
                                upfront fees or upkeep.
                            </div>
                            <a
                    ...
                    <div className="w-row">
                        <div className="w-col w-col-4">
                            ...
                            <p>
                                ...
                                customize and extend functionality without
                                exposing private data. Apps can be freely
                                forked, tweaked, and repurposed.
                            </p>
                        </div>
                        <div className="w-col w-col-4">
                            ...
                            <div className="icon-wrapper">
                                <Image
                                    src={speedometerWhiteImage}
                                    style={{ width: 95, height: 95 }}
                                    alt="Speedometer icon"
                                />
                            </div>
                            <p>
                                By utilizing pay-as-you-go pricing mechanisms,
                                developers can deploy arbitrarily complex or
                                data-intensive applications by letting their
                                users pay reasonably for their own usage, and
                                users never have to worry about their favorite
                        ...
                        <div className="w-col w-col-4">
                            ...
                            <p>
                                By defining reasonable premiums on top of
                                base-layer service costs, application developers
                                and contributors can be fairly compensated based
            ...
            <div className="section image wf-section">
                <div className="w-container">
                    <h1>
                        Open source software has revolutionized how software is
                        developed. Kestrel is designed to create new
                        opportunities for open source software to flourish.
                    </h1>
