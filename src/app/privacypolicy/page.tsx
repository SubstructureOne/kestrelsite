        ...
        <>
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <p>
                    ...
                    Statement of Privacy applies to substructureone.com, and
                    Substructure One, LLC and governs data collection and usage.
                    For the purposes of this Privacy Policy, unless otherwise
                    noted, all references to Substructure One, LLC include
                    substructureone.com, Substructure One and kestrelcodes.com.
                    The Substructure One website is a ecommerce site. By using
                    the Substructure One website, you consent to the data
                ...
                <p>
                    ...
                    offered, Substructure One may collect personally
                ...
                <p>
                    If you purchase Substructure One's products and services, we
                ...
                <p>
                    Substructure One collects and uses your personal information
                    to operate and deliver the services you have requested.
                </p>
                <p>
                    Substructure One may also use your personally identifiable
                    information to inform you of other products or services
                    available from Substructure One and its affiliates.
                </p>
                <h2 className="my-5">Sharing Information with Third Parties</h2>
                <p>
                    Substructure One does not sell, rent or lease its customer
                    lists to third parties.
                </p>
                <p>
                    Substructure One may share data with trusted partners to
                    ...
                    Substructure One, and they are required to maintain the
                    confidentiality of your information.
                </p>
                <p>
                    Substructure One may disclose your personal information,
                    ...
                    on Substructure One or the site; (b) protect and defend the
                    rights or property of Substructure One; and/or (c) act under
                    exigent circumstances to protect the personal safety of
                    users of Substructure One, or the public.
                </p>
                <h2 className="my-5">Tracking User Behavior</h2>
                <p>
                    Substructure One may keep track of the websites and pages
                    our users visit within Substructure One, in order to
                    determine what Substructure One services are the most
                    popular. This data is used to deliver customized content and
                    advertising within Substructure One to customers whose
                    behavior indicates that they are interested in a particular
                    subject area.
                </p>
                <h2 className="my-5">Automatically Collected Information</h2>
                <p>
                    Information about your computer hardware and software may be
                    automatically collected by Substructure One. This
                    ...
                    statistics regarding use of the Substructure One website.
                </p>
                <h2 className="my-5">Use of Cookies</h2>
                <p>
                    The Substructure One website may use "cookies" to help you
                ...
                <p>
                    ...
                    specific page. For example, if you personalize Substructure
                    One pages, or register with Substructure One site or
                    services, a cookie helps Substructure One to recall your
                    specific information on subsequent visits. This simplifies
                    the process of recording your personal information, such as
                    billing addresses, shipping addresses, and so on. When you
                    return to the same Substructure One website, the information
                    you previously provided can be retrieved, so you can easily
                    use the Substructure One features that you customized.
                </p>
                <p>
                    ...
                    Substructure One services or websites you visit.
                </p>
                ...
                <h2 className="my-5">Security of your Personal Information</h2>
                <p>
                    Substructure One secures your personal information from
                    unauthorized access, use, or disclosure. Substructure One
                ...
                <ul className="list-disc">
                    ...
                    <li>
                        therwise use your personal information, internally, in a
                ...
                <p>
                    Substructure One does not knowingly collect personally
                ...
                <p>
                    From time to time, Substructure One may contact you via
                    ...
                    email from Substructure One or click on a link therein.
                </p>
                <p>
                    If you would like to stop receiving marketing or promotional
                    communications via email from Substructure One, you may opt
                    out of such communications by clicking on the UNSUBSCRIBE
                    link..
                </p>
                ...
                <p>
                    Substructure One reserves the right to change this Privacy
                ...
                <p>
                    ...
                    Substructure One has not adhered to this Statement, please
                    contact Substructure One at:
                </p>
                <p>
                ...
                <p>Email Address: contact@substructure.one</p>
                <p>Telephone number: 919-808-2663</p>
                <p>Effective as of March 26, 2023</p>
            </div>
            <Footer />
        </>
    );
