                ...
                <div className="w-row">
                    ...
                    <div className="w-col w-col-4">
                        <div className="footer-text address">
                            <p>
                                Twitter:{" "}
                                <a href="https://twitter.com/substructureone">
                                    @substructureone
                                </a>
                            </p>
                            <p>
                                Github:{" "}
                                <a href="https://github.com/SubstructureOne/">
                                    SubstructureOne
                                </a>
                            </p>
                            <p>
                                Email:{" "}
                                <a href="mailto:contact@substructure.one">
                                    contact@substructure.one
                                </a>
                            </p>
                        </div>
                    </div>
